...
namespace ChallengesWithTestsMarkVII.Tests
{
    public class ChallengesSet04Tests
    {
        ...
        [InlineData(new string[] { null, "test", "test", null, null }, false)]
        [InlineData(new string[] { null, null, "test", null, "test" }, false)]
        [InlineData(new string[] { null, "test", null, "test", null }, false)]
